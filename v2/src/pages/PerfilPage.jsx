        ...
        <div>
          <div className="detail-panel">
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
              <div className="avatar" style={{ width: 56, height: 56, fontSize: 20, background: 'var(--accent)' }}>{initials}</div>
              <div>
            ...
            {!editing ? (
              <>
                ...
                <button className="btn btn-primary btn-sm" style={{ marginTop: 16 }} onClick={() => setEditing(true)}>
